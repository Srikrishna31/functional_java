...
TARGETS = [
    ...
    (
        "fileio",
        ["test/java/com/io/ReadFile.java", "test/java/com/io/Person.java"],
        "com.io.ReadFile",
        [],
    ...
    (
        "actor_pingpong",
        ["test/java/com/actor/pingpong/PingPong.java", "test/java/com/actor/pingpong/Player.java"],
        "com.actor.pingpong.PingPong",
        [],
        [],
    ),
    (
        ...
        [
            ...
            "test/java/com/actor/fibonacci/Manager.java",
            "test/java/com/actor/fibonacci/Worker.java",
        ],
